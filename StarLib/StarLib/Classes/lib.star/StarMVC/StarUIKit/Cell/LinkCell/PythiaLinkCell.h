...
@class PythiaLinkCell;

@protocol PythiaLinkCellDelegate <NSObject>

@optional
- (void)linkCell:(PythiaLinkCell *)linkCell didSelectLinkWithFlag:(NSString *)linkFlag;

@end



@interface PythiaLinkCell : WexTableViewCell
...
@property (nonatomic, weak) id<PythiaLinkCellDelegate> delegate;
