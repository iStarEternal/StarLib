...
+ (void)setInfoDuration:(NSTimeInterval)infoDuration {
    [self sharedView].infoDuration = infoDuration;
}

+ (void)setSuccessDuration:(NSTimeInterval)successDuration {
    [self sharedView].successDuration = successDuration;
}

+ (void)setErrorDuration:(NSTimeInterval)errorDuration {
    [self sharedView].errorDuration = errorDuration;
}
...
+ (void)showSuccessWithStatus:(NSString*)status {
    [self showImage:[self sharedView].successImage status:status duration:[self sharedView].successDuration];
}
...
+ (void)showErrorWithStatus:(NSString*)status {
    [self showImage:[self sharedView].errorImage status:status duration:[self sharedView].errorDuration];
}
...
+ (void)showImage:(UIImage*)image status:(NSString*)status duration:(NSTimeInterval)duration {
    duration = [self displayDurationForString:status withDuration:duration];
...
+ (NSTimeInterval)displayDurationForString:(NSString *)string withDuration:(NSTimeInterval)duration {
    return MAX((float)string.length * 0.06 + 0.5, duration);
}
...
- (void)setInfoDuration:(NSTimeInterval)infoDuration {
    if (!_isInitializing) _infoDuration = infoDuration;
}

- (void)setSuccessDuration:(NSTimeInterval)successDuration {
    if (!_isInitializing) _successDuration = successDuration;
}

- (void)setErrorDuration:(NSTimeInterval)errorDuration {
    if (!_isInitializing) _errorDuration = errorDuration;
}
