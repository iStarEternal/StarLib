...
@property (assign, nonatomic) NSTimeInterval infoDuration;                          // default is 2.5 seconds
@property (assign, nonatomic) NSTimeInterval successDuration;                       // default is 1.5 seconds
@property (assign, nonatomic) NSTimeInterval errorDuration;                         // default is 2.0 seconds
...
+ (void)setInfoDuration:(NSTimeInterval)infoDuration;               // default is 2.5 seconds
+ (void)setSuccessDuration:(NSTimeInterval)successDuration;         // default is 1.5 seconds
+ (void)setErrorDuration:(NSTimeInterval)errorDuration;             // default is 2.0 seconds
