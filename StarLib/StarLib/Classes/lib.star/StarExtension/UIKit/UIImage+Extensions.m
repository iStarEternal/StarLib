...
+ (UIImage *)originalImageNamed:(NSString *)name {
    return [self imageNamed:name].originalImage;
}
...
+ (UIImage *)templateImageNamed:(NSString *)name {
    return [self imageNamed:name].templateImage;
}
...
- (UIImage *(^)(CGFloat))imageWithAlpha {
...
@implementation UIColor (StarImageExtension)
