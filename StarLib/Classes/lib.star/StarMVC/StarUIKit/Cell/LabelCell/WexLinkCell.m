...
@implementation WexLinkCell


#pragma mark - 析构函数

- (void)dealloc {
    [self removeObserver:self forKeyPath:@"frame" context:WexLinkCellFrameChanged];
}
...
- (void)wex_loadViews {
    ...
    [self addObserver:self forKeyPath:@"frame" options:options context:WexLinkCellFrameChanged];
...
- (void)appendNormalText:(NSString *)text {
    [self appendRichStringWithText:text textColor:@"#999999".xc_color textFont:@"label_13px_font".xc_font isLink:false linkFlag:nil];
}

- (void)appendLinkText:(NSString *)text linkFlag:(NSString *)linkFlag {
    [self appendRichStringWithText:text textColor:@"#2D99FA".xc_color textFont:@"label_13px_font".xc_font isLink:true linkFlag:linkFlag];
}
...
- (void)appendRichStringWithText:(NSString *)text textColor:(UIColor *)textColor textFont:(UIFont *)font isLink:(BOOL)isLink linkFlag:(NSString *)linkFlag {
    ...
    WexRichString *richString = [[WexRichString alloc] init];
...
- (void)appendRichString:(WexRichString *)richString {
...
- (NSAttributedString *)createAttributedStringWithAttributedStringArray:(NSArray *)attributedStringArray {
    ...
    for (WexRichString *richString in attributedStringArray) {
...
- (void)observeValueForKeyPath:(NSString *)keyPath ofObject:(id)object change:(NSDictionary *)change context:(void *)context {
    if (context == WexLinkCellFrameChanged) {
        [self layoutSubviews];
    } else {
