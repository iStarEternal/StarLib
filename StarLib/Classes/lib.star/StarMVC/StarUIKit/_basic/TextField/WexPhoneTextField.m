...
@interface WexPhoneTextFieldHelper() <UITextFieldDelegate>

@property (nonatomic, weak) WexPhoneTextField* textField;

@end

@implementation WexPhoneTextFieldHelper

- (instancetype)initWithPhoneTextField:(WexPhoneTextField*)textField {
    self = [super init];
...
- (BOOL)textField                       :(UITextField *)textField
    ...
    self.textField.previousTextFieldContent = textField.text;
    self.textField.previousSelection = textField.selectedTextRange;
    
    id<UITextFieldDelegate> pDelegate = ((WexPhoneTextField*)textField).phoneTextFieldDelegate;
...
@interface WexPhoneTextField ()

@property (nonatomic, strong) WexPhoneTextFieldHelper* helper;
...
@implementation WexPhoneTextField
...
- (void)setupFormat {
    ...
    self.helper = [[WexPhoneTextFieldHelper alloc] initWithPhoneTextField:self];
